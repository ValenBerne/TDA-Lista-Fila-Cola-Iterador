...
void probar_operaciones_lista(){
 lista_t* lista = lista_crear();
  ...
  printf("%c ", *(char*)lista_elemento_en_posicion(lista, 0));
  lista_insertar(lista, &c);
  printf("%c ", *(char*)lista_elemento_en_posicion(lista, 1));
  ...
  printf("%c ", *(char*)lista_elemento_en_posicion(lista, 1));
  printf("%c ", *(char*)lista_elemento_en_posicion(lista, 2));
  printf("%c ", *(char*)lista_elemento_en_posicion(lista, 3));
